...
public class registerNewUserAccountPage {
    public int random;
...
// Methods declaration
    ...
    public void iEnterUserPersonalDetails () {
        GenderButton.click();
        ...
        NewUserEmailField.sendKeys("summer+2022" + random + "@gmail.com");
    }
    public void iEnterNewPasswordConfirmPasswordAndClickRegisterButton () {
        NewUserPasswordField.sendKeys("testing");
        ConfirmPasswordField.sendKeys("testing");
